<div class="container h-100 d-flex justify-content-center p-0 gap-4">
                    ...
                    <div class="col-8">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select class="form-select" id="unitPrice" name="inquiryUnit" onchange="updateUnitName()"
                                ...
                                <option value="1068000" data-unit-name="Mitsubishi Xpander 1.5 GLX MT 2024">Mitsubishi Xpander 1.5 GLX MT 2024</option>
                                <option value="1128000" data-unit-name="Mitsubishi Xpander 1.5 GLX AT 2024">Mitsubishi Xpander 1.5 GLX AT 2024</option>
                                <option value="1198000" data-unit-name="Mitsubishi Xpander 1.5 GLS AT 2024">Mitsubishi Xpander 1.5 GLS AT 2024</option>
                            </select>
                        </div>
    ...
    <div class="container w-25 shadow-lg rounded-3">
        <div class="container">
            <img src="images/car-images/xpander.png" class="img-fluid h-100 w-100 rounded-3 my-4" alt="...">
            <p><b>Quick Payment Preview</b></p>
            <div class="container p-0">
                <p>Unit Name : MITSUBISHI XPANDER</p>
