<div class="container h-100 d-flex justify-content-center p-0 gap-4">
                    ...
                    <div class="col-8">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select class="form-select" id="unitPrice" name="inquiryUnit" onchange="updateUnitName()"
                                ...
                                <option value="1083000" data-unit-name="Geely Coolray 1.5 Comfort Turbo SE 2024">Geely Coolray 1.5 Comfort Turbo SE 2024</option>
                                <option value="1218000" data-unit-name="Geely Coolray 1.5 Premium Turbo SE 2024">Geely Coolray 1.5 Premium Turbo SE 2024</option>
                                <option value="1299000" data-unit-name="Geely Coolray 1.5 Sport Turbo SE 2024">Geely Coolray 1.5 Sport Turbo SE 2024</option>
                            </select>
                        </div>
    ...
    <div class="container w-25 shadow-lg rounded-3">
        <div class="container">
            <img src="images/car-images/coolray.png" class="img-fluid h-100 w-100 rounded-3 my-4" alt="...">
            <p><b>Quick Payment Preview</b></p>
            <div class="container p-0">
                <p>Unit Name : GEELY COOLRAY</p>
