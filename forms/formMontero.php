<div class="container h-100 d-flex justify-content-center p-0 gap-4">
                    ...
                    <div class="col-8">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select class="form-select" id="unitPrice" name="inquiryUnit" onchange="updateUnitName()"
                                ...
                                <option value="1568000" data-unit-name="Mitsubishi Montero Sport GLX 2.4 4x2 MT 2024">Mitsubishi Montero Sport GLX 2.4 4x2 MT 2024</option>
                                <option value="1828000" data-unit-name="Mitsubishi Montero Sport GLS 2.4 4x2 AT 2024">Mitsubishi Montero Sport GLS 2.4 4x2 AT 2024</option>
                                <option value="2103000" data-unit-name="Mitsubishi Montero Sport 2.4 Black Series 4x2 AT 2024">Mitsubishi Montero Sport 2.4 Black Series 4x2 AT 2024</option>
                                <option value="2118000" data-unit-name="Mitsubishi Montero Sport 2.4 Black Series 4x2 AT (White Diamond) 2024">Mitsubishi Montero Sport 2.4 Black Series 4x2 AT (White Diamond) 2024</option>
                                <option value="2122000" data-unit-name="Mitsubishi Montero Sport 2.4 Black Series RALLIART AT 2024">Mitsubishi Montero Sport 2.4 Black Series RALLIART AT 2024</option>
                                <option value="2428000" data-unit-name="Mitsubishi Montero Sport GT 2.4 4x4 AT 2024">Mitsubishi Montero Sport GT 2.4 4x4 AT 2024</option>
                            </select>
                        </div>
    ...
    <div class="container w-25 shadow-lg rounded-3">
        <div class="container">
            <img src="images/car-images/montero.png" class="img-fluid h-100 w-100 rounded-3 my-4" alt="...">
            <p><b>Quick Payment Preview</b></p>
            <div class="container p-0">
                <p>Unit Name : MITSUBISHI MONTERO</p>
