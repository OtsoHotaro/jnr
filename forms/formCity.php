<div class="container h-100 d-flex justify-content-center p-0 gap-4">
            ...
            <div class="container d-flex flex-column p-4">
                ...
                <div class="row my-1">
                    <div class="col-8">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select class="form-select" id="unitPrice" name="inquiryUnit" onchange="updateUnitName()"
                                ...
                                <option value="973000" data-unit-name="Honda City 1.5 E CVT Honda SENSING 2024">Honda City 1.5 E CVT Honda SENSING 2024</option>
                                <option value="998000" data-unit-name="Honda City 1.5 S CVT Honda SENSING 2024">Honda City 1.5 S CVT Honda SENSING 2024</option>
                                <option value="1073000" data-unit-name="Honda City 1.5 V CVT Honda SENSING 2024">Honda City 1.5 V CVT Honda SENSING 2024</option>
                                <option value="1093000" data-unit-name="Honda City 1.5 V CVT Honda SENSING (Platinum White Pearl) 2024">Honda City 1.5 V CVT Honda SENSING (Platinum White Pearl) 2024</option>
                                <option value="1128000" data-unit-name="Honda City 1.5 RS CVT Honda SENSING 2024">Honda City 1.5 RS CVT Honda SENSING 2024</option>
                                <option value="1148000" data-unit-name="Honda City 1.5 RS CVT Honda SENSING (Platinum White Pearl) 2024">Honda City 1.5 RS CVT Honda SENSING (Platinum White Pearl) 2024</option>
                            </select>
                        </div>
                    ...
                    <div class="col-4">
                        ...
                        <input type="text" class="form-control text-start" value="HONDA" disabled>
                        <input type="hidden" name="inquiryBrand" value="HONDA">
                    </div>
                </div>
                <div class="row my-1">
                    <div class="col-8">
    ...
    <div class="container w-25 shadow-lg rounded-3">
        <div class="container">
            <img src="images/car-images/city.png" class="img-fluid h-100 w-100 rounded-3 my-4" alt="...">
            <p><b>Quick Payment Preview</b></p>
            <div class="container p-0">
                <p>Unit Name : HONDA CITY</p>
