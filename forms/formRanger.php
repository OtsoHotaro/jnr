<div class="container h-100 d-flex justify-content-center p-0 gap-4">
            ...
            <div class="container d-flex flex-column p-4">
                ...
                <div class="row my-1">
                    <div class="col-8">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select class="form-select" id="unitPrice" name="inquiryUnit" onchange="updateUnitName()"
                                ...
                                <option value="1249000" data-unit-name="Ford Ranger 2.0 Turbo XL 4x4 MT 2024">Ford Ranger 2.0 Turbo XL 4x4 MT 2024</option>
                                <option value="1249000" data-unit-name="Ford Ranger 2.0 Turbo XLS 4x2 MT 2024">Ford Ranger 2.0 Turbo XLS 4x2 MT 2024</option>
                                <option value="1324000" data-unit-name="Ford Ranger 2.0 Turbo XLS 4x2 AT 2024">Ford Ranger 2.0 Turbo XLS 4x2 AT 2024</option>
                                <option value="1379000" data-unit-name="Ford Ranger 2.0 Turbo XLT 4x2 AT 2024">Ford Ranger 2.0 Turbo XLT 4x2 AT 2024</option>
                                <option value="1494000" data-unit-name="Ford Ranger 2.0 Turbo Sport 4x2 AT 2024">Ford Ranger 2.0 Turbo Sport 4x2 AT 2024</option>
                                <option value="1604000" data-unit-name="Ford Ranger 2.0 Turbo Wildtrak 4x2 AT 2024">Ford Ranger 2.0 Turbo Wildtrak 4x2 AT 2024</option>
                                <option value="1614000" data-unit-name="Ford Ranger 2.0 Turbo Sport 4x4 AT">Ford Ranger 2.0 Turbo Sport 4x4 AT</option>
                                <option value="1619000" data-unit-name="Ford Ranger 2.0 Turbo Wildtrak 4x2 AT (Snowflake White Pearl) 2024">Ford Ranger 2.0 Turbo Wildtrak 4x2 AT (Snowflake White Pearl) 2024</option>
                                <option value="1910000" data-unit-name="Ford Ranger 2.0 Bi-Turbo Wildtrak 4x4 AT 2024">Ford Ranger 2.0 Bi-Turbo Wildtrak 4x4 AT 2024</option>
                                <option value="1925000" data-unit-name="Ford Ranger 2.0 Bi-Turbo Wildtrak 4x4 AT (Snowflake White Pearl) 2024">Ford Ranger 2.0 Bi-Turbo Wildtrak 4x4 AT (Snowflake White Pearl) 2024</option>
                            </select>
                        </div>
                    ...
                    <div class="col-4">
                        ...
                        <input type="text" class="form-control text-start" value="FORD" disabled>
                        <input type="hidden" name="inquiryBrand" value="FORD">
                    </div>
                </div>
                <div class="row my-1">
                    <div class="col-8">
    ...
    <div class="container w-25 shadow-lg rounded-3">
        <div class="container">
            <img src="images/car-images/ranger.png" class="img-fluid h-100 w-100 rounded-3 my-4" alt="...">
            <p><b>Quick Payment Preview</b></p>
            <div class="container p-0">
                <p>Unit Name : FORD RANGER</p>
