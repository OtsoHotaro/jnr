<div class="container h-100 d-flex justify-content-center p-0 gap-4">
            ...
            <div class="container d-flex flex-column p-4">
                ...
                <div class="row my-1">
                    <div class="col-8">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select class="form-select" id="unitPrice" name="inquiryUnit" onchange="updateUnitName()"
                                ...
                                <option value="825000" data-unit-name="Mitsubishi Strada Cab and Chassis 2.5D 4x2 MT 2024">Mitsubishi Strada Cab and Chassis 2.5D 4x2 MT 2024</option>
                                <option value="1048000" data-unit-name="Mitsubishi Strada GL 4x2 MT 2024">Mitsubishi Strada GL 4x2 MT 2024</option>
                                <option value="1225000" data-unit-name="Mitsubishi Strada GL 4x4 MT 2024">Mitsubishi Strada GL 4x4 MT 2024</option>
                                <option value="1320000" data-unit-name="Mitsubishi Strada GLS 4x2 MT 2024">Mitsubishi Strada GLS 4x2 MT 2024</option>
                                <option value="1395000" data-unit-name="Mitsubishi Strada GLS 4x2 AT 2024">Mitsubishi Strada GLS 4x2 AT 2024</option>
                                <option value="1429000" data-unit-name="Mitsubishi Strada GLS RALLIART 4x2 AT 2024">Mitsubishi Strada GLS RALLIART 4x2 AT 2024</option>
                                <option value="1496000" data-unit-name="Mitsubishi Strada Athlete 4x2 AT 2024">Mitsubishi Strada Athlete 4x2 AT 2024</option>
                                <option value="1496000" data-unit-name="Mitsubishi Strada GLS S-Limited 2024">Mitsubishi Strada GLS S-Limited 2024</option>
                                <option value="1549000" data-unit-name="Mitsubishi Strada GLS 4x4 MT 2024">Mitsubishi Strada GLS 4x4 MT 2024</option>
                                <option value="1827000" data-unit-name="Mitsubishi Strada Athlete 4x4 AT 2024">Mitsubishi Strada Athlete 4x4 AT 2024</option>
                            </select>
                        </div>
                    ...
                    <div class="col-4">
                        ...
                        <input type="text" class="form-control text-start" value="MITSUBISHI" disabled>
                        <input type="hidden" name="inquiryBrand" value="MITSUBISHI">
                    </div>
                </div>
                <div class="row my-1">
                    <div class="col-8">
    ...
    <div class="container w-25 shadow-lg rounded-3">
        <div class="container">
            <img src="images/car-images/strada.png" class="img-fluid h-100 w-100 rounded-3 my-4" alt="...">
            <p><b>Quick Payment Preview</b></p>
            <div class="container p-0">
                <p>Unit Name : MITSUBISHI STRADA</p>
