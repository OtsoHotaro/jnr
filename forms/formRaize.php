<div class="container h-100 d-flex justify-content-center p-0 gap-4">
                    ...
                    <div class="col-8">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select class="form-select" id="unitPrice" name="inquiryUnit" onchange="updateUnitName()"
                                ...
                                <option value="751000" data-unit-name="Toyota Raize 1.2 E MT 2024">Toyota Raize 1.2 E MT 2024</option>
                                <option value="841000" data-unit-name="Toyota Raize 1.2 E CVT 2024">Toyota Raize 1.2 E CVT 2024</option>
                                <option value="936000" data-unit-name="Toyota Raize 1.2 G CVT 2024">Toyota Raize 1.2 G CVT 2024</option>
                                <option value="1063000" data-unit-name="Toyota Raize 1.0 Turbo CVT 2024">Toyota Raize 1.0 Turbo CVT 2024</option>
                                <option value="1068000" data-unit-name="Toyota Raize 1.0 Turbo CVT (White Pearl SE/Black) 2024">Toyota Raize 1.0 Turbo CVT (White Pearl SE/Black) 2024</option>
                            </select>
                        </div>
    ...
    <div class="container w-25 shadow-lg rounded-3">
        <div class="container">
            <img src="images/car-images/raize.png" class="img-fluid h-100 w-100 rounded-3 my-4" alt="...">
            <p><b>Quick Payment Preview</b></p>
            <div class="container p-0">
                <p>Unit Name : TOYOTA RAIZE</p>
