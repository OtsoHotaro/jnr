<div class="container h-100 d-flex justify-content-center p-0 gap-4">
                    ...
                    <div class="col-8">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select class="form-select" id="unitPrice" name="inquiryUnit" onchange="updateUnitName()"
                                ...
                                <option value="1335000" data-unit-name="Ford Territory 1.5 Titanium 2024">Ford Territory 1.5 Titanium 2024</option>
                                <option value="1599000" data-unit-name="Ford Territory 1.5 Titanium X 2024">Ford Territory 1.5 Titanium X 2024</option>
                            </select>
                        </div>
    ...
    <div class="container w-25 shadow-lg rounded-3">
        <div class="container">
            <img src="images/car-images/territory.png" class="img-fluid h-100 w-100 rounded-3 my-4" alt="...">
            <p><b>Quick Payment Preview</b></p>
            <div class="container p-0">
                <p>Unit Name : FORD TERRITORY</p>
