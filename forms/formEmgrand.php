<div class="container h-100 d-flex justify-content-center p-0 gap-4">
                    ...
                    <div class="col-8">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select class="form-select" id="unitPrice" name="inquiryUnit" onchange="updateUnitName()"
                                ...
                                <option value="753000" data-unit-name="Geely Emgrand S 1.5 MT 2024">Geely Emgrand S 1.5 MT 2024</option>
                                <option value="945000" data-unit-name="Geely Emgrand Comfort 1.5 CVT 2024">Geely Emgrand Comfort 1.5 CVT 2024</option>
                                <option value="999000" data-unit-name="Geely Emgrand Premium 1.5 CVT 2024">Geely Emgrand Premium 1.5 CVT 2024</option>
                            </select>
                        </div>
    ...
    <div class="container w-25 shadow-lg rounded-3">
        <div class="container">
            <img src="images/car-images/emgrand.png" class="img-fluid h-100 w-100 rounded-3 my-4" alt="...">
            <p><b>Quick Payment Preview</b></p>
            <div class="container p-0">
                <p>Unit Name : GEELY EMGRAND</p>
