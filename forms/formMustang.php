<div class="container h-100 d-flex justify-content-center p-0 gap-4">
                    ...
                    <div class="col-8">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select class="form-select" id="unitPrice" name="inquiryUnit" onchange="updateUnitName()"
                                ...
                                <option value="3638000" data-unit-name="Ford Mustang 5.0 V8 GT Premium SelectShift AT Fastback 2024">Ford Mustang 5.0 V8 GT Premium SelectShift AT Fastback 2024</option>
                                <option value="3818000" data-unit-name="Ford Mustang 5.0 V8 GT Premium SelectShift AT Convertible 2024">Ford Mustang 5.0 V8 GT Premium SelectShift AT Convertible 2024</option>
                            </select>
                        </div>
    ...
    <div class="container w-25 shadow-lg rounded-3">
        <div class="container">
            <img src="images/car-images/mustang fastback.png" class="img-fluid h-100 w-100 rounded-3 my-4" alt="...">
            <p><b>Quick Payment Preview</b></p>
            <div class="container p-0">
                <p>Unit Name : FORD MUSTANG</p>
