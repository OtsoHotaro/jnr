<div class="container h-100 d-flex justify-content-center p-0 gap-4">
                    ...
                    <div class="col-8">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select class="form-select" id="unitPrice" name="inquiryUnit" onchange="updateUnitName()"
                                ...
                                <option value="1799000" data-unit-name="Ford Everest 2.0 Turbo Trend 4x2 AT 2024">Ford Everest 2.0 Turbo Trend 4x2 AT 2024</option>
                                <option value="2019000" data-unit-name="Ford Everest 2.0 Turbo Limited 4x2 AT">Ford Everest 2.0 Turbo Limited 4x2 AT</option>
                                <option value="2109000" data-unit-name="Ford Everest 2.0 Turbo Sport 4x2 AT">Ford Everest 2.0 Turbo Sport 4x2 AT </option>
                                <option value="2209000" data-unit-name="Ford Everest 2.0 Turbo Titanium+ 4x2 AT">Ford Everest 2.0 Turbo Titanium+ 4x2 AT </option>
                                <option value="2369000" data-unit-name="Ford Everest 2.0 Turbo Wildtrak 4x2 AT">Ford Everest 2.0 Turbo Wildtrak 4x2 AT </option>
                                <option value="2525000" data-unit-name="Ford Everest 2.0 Bi-Turbo Titanium+ 4x4 AT">Ford Everest 2.0 Bi-Turbo Titanium+ 4x4 AT </option>
                            </select>
                        </div>
    ...
    <div class="container w-25 shadow-lg rounded-3">
        <div class="container">
            <img src="images/car-images/everest.png" class="img-fluid h-100 w-100 rounded-3 my-4" alt="...">
            <p><b>Quick Payment Preview</b></p>
            <div class="container p-0">
                <p>Unit Name : FORD EVEREST</p>
