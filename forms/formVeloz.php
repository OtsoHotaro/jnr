<div class="container h-100 d-flex justify-content-center p-0 gap-4">
                    ...
                    <div class="col-8">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select class="form-select" id="unitPrice" name="inquiryUnit" onchange="updateUnitName()"
                                ...
                                <option value="1092000" data-unit-name="Toyota Veloz 1.5 E CVT 2024">Toyota Veloz 1.5 E CVT 2024</option>
                                <option value="1210000" data-unit-name="Toyota Veloz 1.5 G CVT 2024">Toyota Veloz 1.5 G CVT 2024</option>
                                <option value="1225000" data-unit-name="Toyota Veloz 1.5 G CVT Platinum White Pearl 2024">Toyota Veloz 1.5 G CVT Platinum White Pearl 2024</option>
                                <option value="1250000" data-unit-name="Toyota Veloz 1.5 V CVT 2024">Toyota Veloz 1.5 V CVT 2024</option>
                                <option value="1265000" data-unit-name="Toyota Veloz 1.5 V CVT Platinum White Pearl 2024">Toyota Veloz 1.5 V CVT Platinum White Pearl 2024</option>
                            </select>
                        </div>
    ...
    <div class="container w-25 shadow-lg rounded-3">
        <div class="container">
            <img src="images/car-images/veloz.png" class="img-fluid h-100 w-100 rounded-3 my-4" alt="...">
            <p><b>Quick Payment Preview</b></p>
            <div class="container p-0">
                <p>Unit Name : TOYOTA VELOZ</p>
