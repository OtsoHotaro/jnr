<div class="container h-100 d-flex justify-content-center p-0 gap-4">
                    ...
                    <div class="col-8">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select class="form-select" id="unitPrice" name="inquiryUnit" onchange="updateUnitName()"
                                ...
                                <option value="3665000" data-unit-name="Toyota Land Cruiser Prado 4.0 Gas AT Gray Metallic 2024">Toyota Land Cruiser Prado 4.0 Gas AT Gray Metallic 2024</option>
                                <option value="3680000" data-unit-name="Toyota Land Cruiser Prado 4.0 Gas AT White Pearl Crystal Shine 2024">Toyota Land Cruiser Prado 4.0 Gas AT White Pearl Crystal Shine 2024</option>
                                <option value="4487000" data-unit-name="Toyota Land Cruiser Prado 2.8 Diesel AT Gray Metallic 2024">Toyota Land Cruiser Prado 2.8 Diesel AT Gray Metallic 2024</option>
                                <option value="4502000" data-unit-name="Toyota Land Cruiser Prado 2.8 Diesel AT While Pearl Crystal Shine 2024">Toyota Land Cruiser Prado 2.8 Diesel AT While Pearl Crystal Shine 2024</option>
                            </select>
                        </div>
    ...
    <div class="container w-25 shadow-lg rounded-3">
        <div class="container">
            <img src="images/car-images/prado.png" class="img-fluid h-100 w-100 rounded-3 my-4" alt="...">
            <p><b>Quick Payment Preview</b></p>
            <div class="container p-0">
                <p>Unit Name : TOYOTA LC PRADO</p>
