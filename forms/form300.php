<div class="container h-100 d-flex justify-content-center p-0 gap-4">
            ...
            <div class="container d-flex flex-column p-4">
                <div class="row my-1">
                    <div class="col-8">
                        ...
                        <input type="text" class="form-control text-start" name="inquiryName" placeholder="Input your Full Name" required>
                    ...
                    <div class="col-4">
                        ...
                        <input type="number" class="form-control text-start" placeholder="Input your Contact Number" name="inquiryContact" required>
                ...
                <div class="row my-1">
                    <div class="col-8">
                        ...
                        <input type="email" class="form-control text-start" name="inquiryEmail" placeholder="Input your Email Address" required>
                    </div>
                    <div class="col-4">
                        <label for="name" class="col-1 col-form-label"><b>Location</b></label>
                        <input type="text" class="form-control text-start" name="inquiryCity" placeholder="Input your Current City Location" required>
                    </div>
                </div>
                <div class="row my-1">
                    <div class="col-8">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select class="form-select" id="unitPrice" name="inquiryUnit" onchange="updateUnitName()" required>
                                <option selected disabled value="">Choose...</option>
                                <option value="5390000" data-unit-name="Toyota Land Cruiser 300 VX AT 2024">Toyota Land
                                    Cruiser 300 VX AT 2024</option>
                                <option value="5405000" data-unit-name="Toyota Land Cruiser 300 VX AT (White Pearl Crystal Shine) 2024">
                                    Toyota Land Cruiser 300 VX AT (White Pearl Crystal Shine) 2024</option>
                                <option value="5732000" data-unit-name="Toyota Land Cruiser 300 ZX AT 2024">Toyota Land
                                    Cruiser 300 ZX AT 2024</option>
                                <option value="5747000" data-unit-name="Toyota Land Cruiser 300 ZX AT (Precious White Pearl) 2024">Toyota
                                    Land Cruiser 300 ZX AT (Precious White Pearl) 2024</option>
                            </select>
                        </div>
                ...
                <div class="row my-1">
                    <div class="col-8">
                        ...
                        <div class="container mt-2 p-0">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="term" value="24" id="2" onclick="updateInterestRate(this)" required>
                                <label class="form-check-label" for="2">2 Years</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="term" value="36" id="3" onclick="updateInterestRate(this)">
                                <label class="form-check-label" for="3">3 Years</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="term" value="48" id="4" onclick="updateInterestRate(this)">
                                <label class="form-check-label" for="4">4 Years</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="term" value="60" id="5" onclick="updateInterestRate(this)">
                    ...
                    <div class="col-4">
                        ...
                        <input type="text" class="form-control text-start" name="inquiryReferral" placeholder="Input your Referral Code" required>
                    </div>
                </div>
                <div class="row my-1">
                    <div class="col-8">
                        ...
                        <div class="container mt-2 p-0">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="dp" value=".2" onchange="result()" id="20" required>
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-success" data-bs-dismiss="modal">Yes, I agree!</button>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container w-25 shadow-lg rounded-3">
        <div class="container">
            <img src="images/car-images/lc300.png" class="img-fluid h-100 w-100 rounded-3 my-4" alt="...">
            <p><b>Quick Payment Preview</b></p>
            <div class="container p-0">
                <p>Unit Name : TOYOTA LC 300</p>
                <p id="displayunitPrice"></p>
                <p id="term"></p>
                <p id="downpayment"></p>
                <p id="result"></p>
                <p id="estText">*This is Sample Comptation only.</p>
            </div>
        </div>
    </div>
</div>