<div class="container h-100 d-flex justify-content-center p-0 gap-4">
            ...
            <div class="container d-flex flex-column p-4">
                ...
                <div class="row my-1">
                    ...
                    <div class="col-4">
                        ...
                        <input type="text" class="form-control text-start" name="inquiryCity"
                            placeholder="Input your Current City Location" required>
                    </div>
                </div>
                <div class="row my-1">
                    <div class="col-8">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select class="form-select" id="unitPrice" name="inquiryUnit" onchange="updateUnitName()"
                                ...
                                <option value="833000" data-unit-name="Toyota Avanza 1.3 J MT 2024">Toyota Avanza 1.3 J
                                    MT 2024</option>
                                <option value="948000" data-unit-name="Toyota Avanza 1.3 E MT 2024">Toyota Avanza 1.3 E
                                    MT 2024</option>
                                <option value="1004000" data-unit-name="Toyota Avanza 1.3 E CVT 2024">Toyota Avanza 1.3
                                    E CVT 2024</option>
                                <option value="1059000" data-unit-name="Toyota Avanza 1.5 G CVT 2024">Toyota Avanza 1.5
                                    G CVT 2024</option>
                            </select>
                        </div>
    ...
    <div class="container w-25 shadow-lg rounded-3">
        <div class="container">
            <img src="images/car-images/avanza.png" class="img-fluid h-100 w-100 rounded-3 my-4" alt="...">
            <p><b>Quick Payment Preview</b></p>
            <div class="container p-0">
                <p>Unit Name : TOYOTA AVANZA</p>
